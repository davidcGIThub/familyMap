...
public class ReturnEventServiceTest {
    ...
    ReturnEventService eventService2;
    ...
    public void setUp() throws Exception
    {
        try
        {
            ...
            eventRequest2 = new EventRequest("eventID0", "tok2");
            eventService2 = new ReturnEventService();
        }
    ...
    public void serve() throws Exception
    {
        ...
        EventResult eventResult2 = eventService2.serve(eventRequest2);
        assertEquals(null, eventResult.getErrorResponse()); // general check to see if there were no errors
        assertEquals("country0", eventResult.getEvent().getCountry()); // check to see if the right event retrieved
        assertEquals("Return Event Service Error: Requested event does not belong to this user", eventResult2.getErrorResponse());
